...
This directory contains the Vue Router configuration for the QuotaDock frontend application. The router implements a comprehensive navigation system with authentication guards, role-based access control, and lazy loading.
