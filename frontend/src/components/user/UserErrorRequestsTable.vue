      ...
      <table class="min-w-full text-sm">
        ...
        <tbody>
          <tr
            v-for="(row, i) in rows"
            :key="i"
            class="border-t border-accent-100 dark:border-dark-700 cursor-pointer hover:bg-accent-50 dark:hover:bg-dark-800"
          ...
          >
            ...
            <td class="px-4 py-2">
              ...
              <span
                ...
                class="ml-1 inline-flex items-center rounded px-1 py-px text-[10px] font-medium leading-tight bg-accent-100 text-accent-500 dark:bg-dark-700 dark:text-accent-400"
          ...
          <tr v-if="!loading && rows.length === 0">
            <td colspan="8" class="px-4 py-8 text-center text-accent-400">{{ t('usage.errors.empty') }}</td>
          </tr>
        </tbody>
      </table>
    </div>
