  ...
  >
    <div class="space-y-4">
      ...
      <template v-else>
        ...
        <!-- Usage Note -->
        <div v-if="showPlatformNote" class="flex items-start gap-3 p-3 rounded-lg bg-primary-50 dark:bg-primary-900/20 border border-primary-100 dark:border-primary-800">
...
const operator = (value: string) => wrapToken('text-accent-400', value)
const string = (value: string) => wrapToken('text-amber-200', value)
const comment = (value: string) => wrapToken('text-accent-500', value)
