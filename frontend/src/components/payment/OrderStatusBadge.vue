...
const statusMap: Record<OrderStatus, { key: string; class: string }> = {
  ...
  PAID: { key: 'payment.status.paid', class: 'bg-primary-100 text-primary-800 dark:bg-primary-900/30 dark:text-primary-400' },
  ...
  REFUNDED: { key: 'payment.status.refunded', class: 'bg-accent-100 text-accent-800 dark:bg-accent-900/30 dark:text-accent-400' },
  PARTIALLY_REFUNDED: { key: 'payment.status.partially_refunded', class: 'bg-accent-100 text-accent-800 dark:bg-accent-900/30 dark:text-accent-400' },
