    ...
    <div :class="[
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-2 border-l border-accent-200 pl-3 dark:border-dark-600">
          <button type="button" @click="emit('edit')" class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-accent-500 transition-colors hover:bg-primary-50 hover:text-primary-600 dark:hover:bg-primary-900/20 dark:hover:text-primary-400">
