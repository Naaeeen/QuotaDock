      ...
      <div class="border-t border-accent-200 pt-4 dark:border-dark-700">
        ...
        <div class="space-y-3">
          <div v-for="field in resolvedFields" :key="field.key">
            ...
            />
            <p v-if="field.hintKey" class="mt-1 text-xs leading-relaxed text-accent-500 dark:text-accent-400">
              {{ t(field.hintKey) }}
            </p>
          </div>
        </div>
        ...
        <!-- 服务商 Webhook 提示 -->
        <div v-if="providerWebhookUrl" class="mt-3 rounded-lg border border-primary-200 bg-primary-50 p-3 dark:border-primary-800/50 dark:bg-primary-900/20">
