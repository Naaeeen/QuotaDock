          ...
          <div v-if="paidOrder" class="w-full rounded-xl bg-accent-50 p-4 dark:bg-dark-800">
            <div class="space-y-2 text-sm">
              ...
              <div class="flex justify-between">
                ...
                <span class="font-medium text-accent-900 dark:text-white">{{ paidOrder.order_type === 'balance' ? '$' + paidOrder.amount.toFixed(2) : formatGatewayAmount(paidOrder.amount) }}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-accent-500 dark:text-accent-400">{{ t('payment.orders.payAmount') }}</span>
                <span class="font-medium text-accent-900 dark:text-white">{{ formatGatewayAmount(paidOrder.pay_amount) }}</span>
              </div>
            </div>
          </div>
...
const qrBorderClass = computed(() => {
  if (isAlipay.value) return 'border-[#00AEEF] bg-primary-50 dark:border-[#00AEEF]/70 dark:bg-primary-950/20'
