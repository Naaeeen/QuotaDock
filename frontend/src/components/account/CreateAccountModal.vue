          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'apikey'
                ...
                : 'border-accent-200 hover:border-accent-300 dark:border-dark-600 dark:hover:border-accent-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'service_account'
                ...
                : 'border-accent-200 hover:border-primary-300 dark:border-dark-600 dark:hover:border-primary-700'
            ]"
          >
            <div
              :class="[
          ...
          <div
            :class="[
              ...
              vertexServiceAccountDragActive
                ...
                : 'border-accent-300 bg-accent-50 hover:border-primary-400 hover:bg-primary-50/60 dark:border-dark-500 dark:bg-dark-700/40 dark:hover:border-primary-600 dark:hover:bg-primary-900/10'
            ]"
