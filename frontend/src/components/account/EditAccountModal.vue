    ...
    >
      ...
      <div v-if="account.type === 'apikey'" class="space-y-4">
        ...
        <div class="border-t border-accent-200 pt-4 dark:border-dark-600">
          ...
          <div v-if="poolModeEnabled" class="rounded-lg bg-primary-50 p-3 dark:bg-primary-900/20">
      ...
      <div v-if="account.platform === 'antigravity'" class="border-t border-accent-200 pt-4 dark:border-dark-600">
        ...
        <div>
          <div class="mb-3 rounded-lg bg-accent-50 p-3 dark:bg-accent-900/20">
            <p class="text-xs text-accent-700 dark:text-accent-400">{{ t('admin.accounts.mapRequestModels') }}</p>
          </div>
      ...
      <div
        ...
        class="border-t border-accent-200 pt-4 dark:border-dark-600"
      >
        <div class="overflow-hidden rounded-lg border border-primary-100 bg-primary-50/60 shadow-sm dark:border-primary-900/50 dark:bg-primary-950/20">
          <div class="flex items-start gap-3 px-4 py-3">
            ...
            <div class="min-w-0 flex-1">
              ...
              <p class="mt-1 text-xs leading-5 text-accent-600 dark:text-accent-300">
              ...
              <button
                ...
                :class="[
                  ...
                  codexImageGenerationBridgeMode === option.value
                    ? 'border-primary-300 bg-primary-50 text-primary-900 shadow-sm ring-1 ring-primary-200 dark:border-primary-700 dark:bg-primary-900/25 dark:text-primary-100 dark:ring-primary-800'
                    : 'border-transparent bg-transparent text-accent-600 hover:border-accent-200 hover:bg-accent-50 dark:text-accent-300 dark:hover:border-dark-500 dark:hover:bg-dark-700'
                ]"
              >
                <span
                  :class="[
                    ...
                    codexImageGenerationBridgeMode === option.value
                      ...
                      : 'border-accent-300 text-transparent group-hover:border-accent-400 dark:border-dark-500'
                  ]"
                >
                ...
                <span class="min-w-0">
                  ...
                  <span class="mt-0.5 block text-xs leading-4 text-accent-500 dark:text-accent-400">{{ option.description }}</span>
                </span>
              </button>
            </div>
          </div>
      ...
      <div
        ...
        class="space-y-4 border-t border-accent-200 pt-4 dark:border-dark-600"
      >
        ...
        <div
          ...
          class="rounded-lg bg-accent-50 px-3 py-2 text-xs text-accent-600 dark:bg-dark-700 dark:text-accent-300"
        >
        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            <label
              ...
              :key="option.value"
              class="flex cursor-pointer items-center gap-2 rounded-lg border border-accent-200 px-3 py-2 text-sm dark:border-dark-600"
            >
              <input
                type="checkbox"
                class="rounded border-accent-300 text-primary-600 focus:ring-primary-500 dark:border-dark-500"
              ...
              />
              <span class="text-accent-700 dark:text-accent-200">{{ option.label }}</span>
            </label>
          </div>
      ...
      >
        ...
        <div
          ...
          class="mt-4 flex items-center justify-between border-l-2 border-accent-200 pl-4 dark:border-dark-600"
        >
          <div>
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              codexCLIOnlyAllowClaudeCodeEnabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                autoPause5hDisabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
              ]"
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                autoPause7dDisabled ? 'bg-primary-600' : 'bg-accent-200 dark:bg-dark-600'
              ]"
...
const codexImageGenerationBridgeBadgeClass = computed(() => {
  switch (codexImageGenerationBridgeMode.value) {
    ...
    default:
      return 'bg-accent-100 text-accent-600 dark:bg-dark-600 dark:text-accent-300'
  }
})
