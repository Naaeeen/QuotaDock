<template>
  <div
    class="rounded-lg border border-primary-200 bg-primary-50 p-4 dark:border-primary-700 dark:bg-primary-900/30"
  >
      ...
      <div class="flex-1">
        ...
        <div v-if="inputMethod === 'refresh_token' || inputMethod === 'mobile_refresh_token'" class="space-y-4">
          <div
            class="rounded-lg border border-primary-300 bg-white/80 p-4 dark:border-primary-600 dark:bg-accent-800/80"
          >
                ...
                <div v-if="showProjectId && platform === 'gemini'" class="mb-3">
                  <label class="input-label flex items-center gap-2">
                    ...
                    <a
                      ...
                      class="inline-flex items-center gap-1 text-xs font-normal text-primary-500 hover:text-primary-600 dark:text-primary-400"
                    >
