<template>
  <div>
    ...
    <div
      v-if="isSearchable"
      class="flex items-center gap-2 rounded-t-lg border border-b-0 border-accent-200 bg-accent-50 px-3 py-2 dark:border-dark-600 dark:bg-dark-800"
    >
      <Icon name="search" size="sm" class="shrink-0 text-accent-400" />
      <input
        v-model="searchText"
        type="text"
        :placeholder="t('common.searchPlaceholder')"
        class="flex-1 bg-transparent text-sm text-accent-900 placeholder:text-accent-400 focus:outline-none dark:text-accent-100 dark:placeholder:text-dark-400"
      />
    </div>
    <div
      :class="[
        ...
        isSearchable
          ? 'rounded-b-lg border border-t-0 border-accent-200 bg-accent-50 dark:border-dark-600 dark:bg-dark-800'
          : 'rounded-lg border border-accent-200 bg-accent-50 dark:border-dark-600 dark:bg-dark-800'
      ]"
    >
      <label
