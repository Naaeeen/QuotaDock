<template>
  <div v-if="hasActiveSubscriptions" class="relative" ref="containerRef">
    ...
    <button
      @click="toggleTooltip"
      class="flex cursor-pointer items-center gap-2 rounded-xl bg-accent-50 px-3 py-1.5 transition-colors hover:bg-accent-100 dark:bg-accent-900/20 dark:hover:bg-accent-900/30"
      :title="t('subscriptionProgress.viewDetails')"
    >
      <Icon name="creditCard" size="sm" class="text-accent-600 dark:text-accent-400" />
