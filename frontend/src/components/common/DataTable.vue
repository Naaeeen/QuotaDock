...
.table-wrapper {
  ...
  --dt-header-bg: rgb(250 247 242);
  --dt-header-shadow: rgba(150, 97, 29, 0.18);
  --dt-sticky-bg: rgb(255 252 246);
  --dt-sticky-hover-bg: rgb(250 247 242);
  --dt-edge-shadow: rgba(67, 37, 20, 0.08);
  position: relative;
  overflow-x: auto;
  overflow-y: auto;
  flex: 1;
...
.dark .table-wrapper {
  --dt-header-bg: rgb(37 28 24);
  --dt-header-shadow: rgba(184, 135, 51, 0.18);
  --dt-sticky-bg: rgb(23 18 15);
  --dt-sticky-hover-bg: rgb(37 28 24);
  --dt-edge-shadow: rgba(184, 135, 51, 0.07);
}
...
.table-wrapper .table-header {
  ...
  box-shadow: inset 0 -1px 0 var(--dt-header-shadow);
}
...
/* 表体 sticky 列背景 */
tbody .sticky-col {
  background-color: var(--dt-sticky-bg);
  background-clip: padding-box;
}

/* hover 状态保持 */
tbody tr:hover .sticky-col {
  background-color: var(--dt-sticky-hover-bg);
}
...
.is-scrollable .sticky-col-left::after {
  ...
  background: linear-gradient(to right, var(--dt-edge-shadow), transparent);
  pointer-events: none;
}
...
.is-scrollable .sticky-col-right::before {
  ...
  width: 10px;
  transform: translateX(-100%);
  background: linear-gradient(to left, var(--dt-edge-shadow), transparent);
  pointer-events: none;
}
</style>
