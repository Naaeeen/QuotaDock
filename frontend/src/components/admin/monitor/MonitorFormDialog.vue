<template>
  ...
  >
    <form id="channel-monitor-form" @submit.prevent="handleSubmit" class="space-y-5">
      ...
      <div v-if="form.provider === PROVIDER_OPENAI" class="rounded-lg border border-primary-100 bg-primary-50/50 p-3 dark:border-primary-500/20 dark:bg-primary-500/10">
      ...
      <div>
        ...
        <p class="mt-1 text-xs text-accent-400">{{ t('admin.channelMonitor.form.jitterSecondsHint') }}</p>
      </div>
...
function apiModeButtonClass(mode: APIMode): string {
  ...
  return 'border-primary-100 bg-white/70 text-accent-600 hover:border-primary-300 dark:border-dark-700 dark:bg-dark-800 dark:text-accent-400'
}
