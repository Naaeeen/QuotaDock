              ...
              <div class="flex items-center gap-4">
                ...
                <div class="min-w-0 flex-1">
                  <div class="flex items-center gap-2">
                    ...
                    <span class="inline-flex items-center rounded-full bg-accent-100 px-2 py-0.5 text-xs font-medium text-accent-700 dark:bg-accent-900/40 dark:text-accent-300">
