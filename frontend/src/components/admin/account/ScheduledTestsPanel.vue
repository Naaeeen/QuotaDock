      ...
      <div v-else class="space-y-3">
        ...
        >
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex items-center gap-1" @click.stop>
                <button
                  ...
                  class="rounded-lg p-1.5 text-accent-400 transition-colors hover:bg-primary-50 hover:text-primary-500 dark:hover:bg-primary-900/20"
          ...
          <div
            ...
            class="border-t border-primary-100 bg-primary-50/50 px-4 py-3 dark:border-primary-900 dark:bg-primary-900/10"
            @click.stop
          >
