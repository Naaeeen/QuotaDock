  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div class="card p-4 flex items-center gap-3">
      ...
      <div>
        ...
        <p class="flex flex-wrap items-center gap-x-1 text-xs text-accent-500">
          ...
          <span class="group relative inline-flex cursor-help items-center gap-0.5" tabindex="0">
            ...
            <span
              class="pointer-events-none absolute left-1/2 top-full z-30 mt-2 w-56 -translate-x-1/2 rounded-lg border border-accent-200 bg-white p-3 text-left text-xs text-accent-700 opacity-0 shadow-lg transition-opacity duration-150 group-hover:opacity-100 group-focus:opacity-100 dark:border-dark-600 dark:bg-dark-800 dark:text-accent-200"
            >
              <span class="mb-2 block font-medium text-dark-900 dark:text-accent-50">
                {{ cacheDetailLabel() }}
              </span>
