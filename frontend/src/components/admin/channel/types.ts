...
export function getPlatformTagClass(platform: string): string {
  switch (platform) {
    ...
    case 'gemini': return 'bg-primary-100 text-primary-700 dark:bg-primary-900/30 dark:text-primary-400'
    case 'antigravity': return 'bg-accent-100 text-accent-700 dark:bg-accent-900/30 dark:text-accent-400'
...
export function getPlatformTextClass(platform: string): string {
  switch (platform) {
    ...
    case 'gemini': return 'text-primary-700 dark:text-primary-400'
    case 'antigravity': return 'text-accent-700 dark:text-accent-400'
    default: return ''
  }
}
