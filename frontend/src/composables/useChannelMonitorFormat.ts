...
export function useChannelMonitorFormat() {
   ...
   * Reuses the same emerald/orange/primary palette as providerBadgeClass to keep
    ...
    switch (p) {
      ...
      case PROVIDER_GEMINI:
        return active
          ...
          : 'border-accent-200 bg-white text-accent-600 hover:border-primary-300 hover:text-primary-700 dark:border-dark-700 dark:bg-dark-800 dark:text-accent-400 dark:hover:border-primary-500/50'
      default:
        return active
...
export function providerGradient(provider: string): string {
  switch (provider) {
    ...
    case PROVIDER_GEMINI:
      return 'bg-gradient-to-br from-primary-50 to-accent-100 dark:from-primary-500/10 dark:to-accent-500/20'
    default:
