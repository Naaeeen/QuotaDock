                ...
                >
                  <button
                    ...
                    :class="[
                      ...
                      isForcedVisibleColumn(col.key)
                        ? 'cursor-not-allowed text-accent-400 dark:text-accent-500'
                        : 'text-accent-700 hover:bg-accent-100 dark:text-accent-300 dark:hover:bg-dark-700'
                    ]"
                  ...
                  >
                    ...
                    <Icon
                      ...
                      name="check"
                      size="sm"
                      :class="isForcedVisibleColumn(col.key) ? 'text-accent-400 dark:text-accent-500' : 'text-primary-500'"
                      :stroke-width="2"
                    />
                  </button>
                </div>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-role="{ value }">
            <span :class="['badge', value === 'admin' ? 'badge-accent' : 'badge-neutral']">
          ...
          <template #cell-groups="{ row }">
            <div v-if="allGroups.length > 0" class="flex flex-col gap-1">
              ...
              >
                <Icon name="shield" size="xs" class="h-3.5 w-3.5 text-accent-500 dark:text-accent-400" />
                <span class="font-medium text-accent-600 dark:text-accent-400">{{ getUserGroups(row).exclusive.length }}</span>
          ...
          <template #cell-balance="{ value, row }">
            <div class="flex items-center gap-2">
              <div class="group relative">
                <button
                  class="font-medium text-accent-900 underline decoration-dashed decoration-accent-300 underline-offset-4 transition-colors hover:text-primary-600 dark:text-white dark:decoration-dark-500 dark:hover:text-primary-400"
          ...
          <template #cell-balance_platform_quota="{ row }">
            <button
              type="button"
              class="block text-left underline decoration-dashed decoration-accent-300 underline-offset-4 transition-colors hover:decoration-primary-400 dark:decoration-dark-500"
          ...
          >
            <div class="flex items-center gap-1.5">
              ...
              <div class="usage-sort-trigger relative">
                <button
                  type="button"
                  class="flex items-center gap-1 rounded px-1 py-0.5 transition-colors hover:bg-accent-200 dark:hover:bg-dark-700"
                ...
                <div
                  ...
                  class="absolute right-0 top-full z-50 mt-1 min-w-[120px] rounded-lg border border-accent-200 bg-white py-1 shadow-lg dark:border-dark-600 dark:bg-dark-800"
                >
                  <button
                    v-for="metric in (['today', 'total'] as const)"
                    :key="metric"
                    type="button"
                    class="flex w-full items-center justify-between gap-3 px-3 py-1.5 text-left text-xs normal-case tracking-normal hover:bg-accent-100 dark:hover:bg-dark-700"
                  ...
                  <div class="mt-1 border-t border-accent-100 px-3 py-1 text-[10px] normal-case tracking-normal text-accent-400 dark:border-dark-700 dark:text-dark-500">
          ...
          <template v-for="user in users" :key="user.id">
            <template v-if="user.id === activeMenuId">
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-accent-700 hover:bg-accent-100 dark:text-accent-300 dark:hover:bg-dark-700"
              >
                <Icon name="chartBar" size="sm" class="text-accent-400" :stroke-width="2" />
