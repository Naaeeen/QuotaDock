<template>
  <div class="card">
    <div
      class="flex flex-col gap-3 border-b border-accent-100 px-6 py-4 dark:border-dark-700 lg:flex-row lg:items-start lg:justify-between"
    >
      <div>
    ...
    <div class="space-y-6 p-6">
      <div
        v-if="loadingList"
        class="flex items-center gap-2 text-sm text-accent-500 dark:text-accent-400"
      >
        <span
      ...
      <template v-else>
        ...
        >
          <div class="flex flex-wrap items-center gap-2">
            <div class="text-sm font-semibold text-accent-900 dark:text-white">
              {{ selectedEventMeta.label }}
            </div>
            <span
              class="rounded-full bg-white px-2.5 py-1 text-xs font-medium text-accent-600 shadow-sm ring-1 ring-accent-200 dark:bg-dark-800 dark:text-accent-300 dark:ring-dark-600"
            >
          ...
          <p class="mt-2 text-sm leading-6 text-accent-600 dark:text-accent-300">
            {{ selectedEventMeta.timing }}
          </p>
          <p
            v-if="selectedEventDescription"
            class="mt-1 text-xs text-accent-500 dark:text-accent-400"
          >
        ...
        <div v-else class="grid grid-cols-1 gap-6 xl:grid-cols-2">
            ...
            >
              ...
              <div class="mt-3 flex flex-wrap gap-2">
                <button
                  ...
                  :key="placeholder"
                  type="button"
                  class="rounded-full border border-accent-200 bg-white px-3 py-1 font-mono text-xs text-accent-700 transition-colors hover:border-primary-300 hover:text-primary-600 dark:border-dark-600 dark:bg-dark-700 dark:text-accent-200 dark:hover:border-primary-500 dark:hover:text-primary-300"
          ...
          <div class="space-y-4">
            <div
              class="rounded-lg border border-accent-200 bg-white dark:border-dark-700 dark:bg-dark-800"
            >
              <div
              ...
              <div class="bg-accent-100 p-3 dark:bg-dark-900">
                <iframe
                  class="h-[36rem] w-full rounded-md border border-accent-200 bg-white dark:border-dark-700"
                  sandbox=""
                  :srcdoc="previewHtml"
