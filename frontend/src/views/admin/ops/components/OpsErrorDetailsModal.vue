          ...
          <div class="col-span-2 compact-select">
            <div class="relative group">
              <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                <svg
                  class="h-3.5 w-3.5 text-accent-400 transition-colors group-focus-within:text-primary-500"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <input
                v-model="q"
                type="text"
                class="w-full rounded-lg border-accent-200 bg-accent-50/50 py-1.5 pl-9 pr-3 text-xs font-medium text-accent-700 transition-all focus:border-primary-500 focus:bg-white focus:ring-2 focus:ring-primary-500/10 dark:border-dark-700 dark:bg-dark-900 dark:text-accent-300 dark:focus:bg-dark-800"
