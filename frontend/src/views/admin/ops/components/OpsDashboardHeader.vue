...
const healthScoreColor = computed(() => {
  if (isSystemIdle.value) return '#c5a989' // accent-400
  const score = healthScoreValue.value
  if (score == null) return '#c5a989'
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 border-b border-accent-100 pb-4 dark:border-dark-700">
      ...
      <div class="flex flex-wrap items-center gap-3">
        ...
        <button
          v-if="!props.fullscreen"
          type="button"
          class="flex h-8 items-center gap-1.5 rounded-lg bg-primary-100 px-3 text-xs font-bold text-primary-700 transition-colors hover:bg-primary-200 dark:bg-primary-900/30 dark:text-primary-400 dark:hover:bg-primary-900/50"
      ...
      <div class="space-y-4">
        <div>
          ...
          <input
            ...
            type="datetime-local"
            class="w-full rounded-lg border border-accent-300 bg-white px-3 py-2 text-sm text-accent-900 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 dark:border-dark-600 dark:bg-dark-800 dark:text-white"
          />
        </div>
        <div>
          <label class="block text-sm font-medium text-accent-700 dark:text-accent-300 mb-1">
