    ...
    <div v-else-if="runtimeSettings && emailConfig && advancedSettings" class="space-y-6">
          ...
          <div v-if="emailConfig.alert.enabled">
            ...
            <div class="mt-2 flex flex-wrap gap-2">
              <span
                ...
                :key="email"
                class="inline-flex items-center gap-2 rounded-full bg-primary-100 px-3 py-1 text-xs font-medium text-primary-700 dark:bg-primary-900/30 dark:text-primary-400"
              >
                {{ email }}
      ...
      <details class="rounded-2xl bg-accent-50 dark:bg-dark-700/50">
        ...
        <div class="space-y-4 px-4 pb-4">
          ...
          <div class="space-y-3">
            <h5 class="text-xs font-semibold text-accent-700 dark:text-accent-300">{{ t('admin.ops.settings.openaiQuotaAutoPause') }}</h5>
            <p class="text-xs text-accent-500">{{ t('admin.ops.settings.openaiQuotaAutoPauseHint') }}</p>
            ...
            <p class="text-xs text-accent-500">{{ t('admin.ops.settings.openaiQuotaAutoPauseThresholdHint') }}</p>
          </div>
