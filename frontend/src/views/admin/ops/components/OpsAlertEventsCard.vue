...
function severityBadgeClass(severity: string | undefined): string {
  ...
  if (s === 'p2' || s === 'info') return 'bg-primary-100 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300'
...
function statusBadgeClass(status: string | undefined): string {
  ...
  if (s === 'manual_resolved') return 'bg-accent-50 text-accent-700 ring-accent-600/20 dark:bg-accent-900/30 dark:text-accent-300 dark:ring-accent-500/30'
