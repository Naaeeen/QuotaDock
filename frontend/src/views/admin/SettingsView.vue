          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
                <div class="rounded-lg border border-accent-200 p-4 dark:border-dark-700">
                  ...
                  <div v-if="form.github_oauth_enabled" class="mt-4 space-y-4">
                    <div class="rounded-lg bg-accent-50 px-3 py-2 text-xs text-accent-600 dark:bg-dark-800 dark:text-accent-300">
                    ...
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                      <div>
                        <label class="mb-2 block text-sm font-medium text-accent-700 dark:text-accent-300">Client ID</label>
                        <input
                      ...
                      <div>
                        <label class="mb-2 block text-sm font-medium text-accent-700 dark:text-accent-300">Client Secret</label>
                        <input
              ...
              >
                <div class="grid grid-cols-1 gap-6">
                  ...
                  <div
                    ...
                    class="flex items-center justify-between pt-4 border-t border-accent-100 dark:border-dark-700"
                  >
                    <div>
                      <label class="font-medium text-accent-900 dark:text-white">{{
                  ...
                  <div
                    v-if="form.dingtalk_connect_corp_restriction_policy === 'internal_only'"
                    class="pt-4 border-t border-accent-100 dark:border-dark-700 space-y-2"
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        <label class="font-medium text-accent-900 dark:text-white">{{
                    ...
                    <div v-if="form.dingtalk_connect_sync_display_name" class="space-y-2">
                      <div class="flex items-center gap-2">
                        <label class="text-sm text-accent-600 dark:text-accent-400 whitespace-nowrap min-w-[5rem]">
                    ...
                    <p v-if="form.dingtalk_connect_sync_display_name" class="text-xs text-accent-400 dark:text-accent-500">
                  ...
                  >
                    ...
                    <p v-if="form.dingtalk_connect_sync_corp_email" class="text-xs text-accent-400 dark:text-accent-500">
                  ...
                  >
                    ...
                    <p v-if="form.dingtalk_connect_sync_dept" class="text-xs text-accent-400 dark:text-accent-500">
              ...
              <div class="border-t border-accent-100 pt-4 dark:border-dark-700">
                ...
                <div class="overflow-x-auto">
                  <table class="min-w-full text-sm">
                    <thead>
                      <tr class="text-left text-xs text-accent-500 dark:text-accent-400">
                    ...
                    <tbody class="space-y-2">
                      <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity'] as const)" :key="p" class="align-top">
                        <td class="pr-4 py-1">
                          <span class="font-mono text-xs text-accent-700 dark:text-accent-300">{{ p }}</span>
                        </td>
                        <td class="pr-4 py-1">
                          <input
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              <div>
                ...
                <div class="space-y-3">
                  <div
                    ...
                    :key="block.id"
                    class="rounded-lg border border-accent-200 bg-accent-50 p-4 dark:border-dark-700 dark:bg-dark-800/60"
                  >
                    <div
                      :class="[
                    ...
                    <div v-show="block.expanded">
                      <div class="grid gap-3 md:grid-cols-2">
                        <div>
                          <label
                            class="mb-1 block text-xs font-medium text-accent-600 dark:text-accent-300"
                          >
                            {{
                              t(
                      ...
                      >
                        <div class="flex items-center justify-between gap-4">
                          <div>
                            <label
                              class="text-xs font-medium text-accent-600 dark:text-accent-300"
                            >
                              {{
                                t(
              ...
              <div class="flex items-center justify-between">
                <div class="pr-4">
                  <label class="block text-sm font-medium text-accent-700 dark:text-accent-300">
	            ...
	            <div class="space-y-6 p-6">
	              <div class="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1fr)_220px]">
	                <div>
	                  ...
	                  <div class="grid grid-cols-2 gap-2 rounded-lg bg-accent-100 p-1 dark:bg-dark-700">
                    <button
                      type="button"
                      ...
                      :class="
                        form.login_agreement_mode === 'modal'
                          ...
                          : 'text-accent-600 hover:text-accent-900 dark:text-dark-300 dark:hover:text-white'
                      "
              ...
              <div>
                ...
                <div class="mt-4 space-y-3">
                  <div
                    ...
                    :key="doc.id || index"
                    class="rounded-lg border border-accent-200 bg-white p-4 dark:border-dark-700 dark:bg-dark-800/60"
                  >
                    <div class="mb-3 flex items-center justify-between gap-3">
                      <div class="flex min-w-0 items-center gap-3">
                        <span class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md bg-accent-100 text-accent-700 dark:bg-dark-700 dark:text-dark-200">
                          <Icon
                            :name="
                              index === 1
                                ? 'shield'
                        ...
                        <div class="min-w-0">
                          <p class="truncate text-sm font-semibold text-accent-900 dark:text-white">
                            {{ doc.title || localText("未命名文档", "Untitled document") }}
                          </p>
                          <p class="truncate text-xs text-accent-500 dark:text-accent-400">
                    ...
                    <div class="grid grid-cols-1 gap-3 lg:grid-cols-2">
                      ...
                      <div>
                        ...
                        <div class="flex overflow-hidden rounded-lg border border-accent-300 bg-white focus-within:border-primary-500 focus-within:ring-1 focus-within:ring-primary-500 dark:border-dark-600 dark:bg-dark-900">
                          <span class="inline-flex flex-shrink-0 items-center border-r border-accent-200 bg-accent-50 px-3 text-sm text-accent-500 dark:border-dark-700 dark:bg-dark-800 dark:text-dark-400">
                            /legal/
                          </span>
                          <input
                            v-model="doc.id"
                            type="text"
                            class="min-w-0 flex-1 border-0 bg-transparent px-3 py-2 text-sm text-accent-900 outline-none placeholder:text-accent-400 focus:ring-0 dark:text-white dark:placeholder:text-dark-500"
              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    >
                      {{
                        (form.payment_product_name_prefix || "QuotaDock") +
                        " 100 " +
...
.settings-tab::before {
  ...
  content: "";
  background: linear-gradient(135deg, rgb(250 247 242 / 0.95), rgb(240 231 216 / 0.82));
}
...
.settings-tab-active::after {
  ...
  content: "";
  background: linear-gradient(90deg, #96611d, #d7a84f);
}
...
.dark .settings-tabs-shell {
  border-color: rgb(122 72 23 / 0.46);
  background: rgb(23 18 15 / 0.88);
  box-shadow:
    0 16px 36px rgb(0 0 0 / 0.28),
    0 1px 0 rgb(184 135 51 / 0.10) inset;
}

.dark .settings-tab::before {
  background: linear-gradient(135deg, rgb(67 37 20 / 0.72), rgb(37 28 24 / 0.82));
}
