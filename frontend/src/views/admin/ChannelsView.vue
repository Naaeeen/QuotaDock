      ...
      <div class="channel-dialog-body">
        ...
        <form id="channel-form" @submit.prevent="handleSubmit" class="flex-1 overflow-y-auto pt-4">
          ...
          >
            ...
            <div v-if="section.platform === 'openai'" class="border-t border-accent-200 pt-3 dark:border-dark-600">
            ...
            <div v-if="section.platform === 'anthropic'" class="border-t border-accent-200 pt-3 dark:border-dark-600">
              <div class="flex items-center justify-between gap-4">
                <div>
                  <label class="text-xs font-medium text-accent-700 dark:text-accent-300">
              ...
              <div class="mb-1 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    class="text-xs text-accent-500 hover:text-primary-600 disabled:opacity-50"
                  >
              ...
              >
                <div class="flex items-center justify-between">
                  <input
                    ...
                    class="bg-transparent text-sm font-medium text-accent-700 placeholder-accent-400 outline-none dark:text-accent-300"
                  />
