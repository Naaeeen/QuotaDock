      ...
      <template #table>
        ...
        >
          ...
          <template #cell-is_exclusive="{ value }">
            <span :class="['badge', value ? 'badge-primary' : 'badge-neutral']">
              {{
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-accent-500 transition-colors hover:bg-accent-100 hover:text-accent-600 dark:hover:bg-dark-700 dark:hover:text-accent-400"
              >
      ...
      >
        ...
        <div class="border-t pt-4">
          ...
          <div
            ...
            class="overflow-hidden rounded-lg border border-accent-200 bg-accent-50/50 dark:border-dark-600 dark:bg-dark-800/40"
          >
            <div
              v-if="!createModelsListLoading && createModelsListState.items.length > 0"
              class="flex items-center justify-between gap-2 border-b border-accent-200 bg-accent-50 px-3 py-2 text-xs dark:border-dark-600 dark:bg-dark-800"
            >
              <span class="text-accent-500 dark:text-accent-400">
              ...
              <div class="flex items-center gap-1.5">
                ...
                <button
                  type="button"
                  class="rounded px-2 py-1 font-medium text-accent-600 transition-colors hover:bg-accent-100 dark:text-accent-300 dark:hover:bg-dark-700"
            ...
            >
              <p v-if="createModelsListLoading" class="text-xs text-accent-500 dark:text-accent-400">
              ...
              <div
                ...
                :key="item.id"
                class="flex items-center gap-2 rounded border border-accent-200 bg-white px-3 py-2 dark:border-dark-600 dark:bg-dark-800"
              >
                <input
                ...
                />
                <span class="min-w-0 flex-1 break-all text-sm text-accent-700 dark:text-accent-300">
                  {{ item.id }}
                </span>
                <button
                  type="button"
                  :disabled="index === 0"
                  class="rounded p-1 text-accent-400 hover:bg-accent-100 hover:text-accent-700 disabled:opacity-40 dark:hover:bg-dark-600 dark:hover:text-accent-200"
        ...
        >
          ...
          <div class="mt-2 rounded-lg bg-accent-50 p-3 text-xs text-accent-700 dark:bg-accent-800 dark:text-accent-300">
        ...
        <div class="border-t pt-4">
          ...
          >
            ...
            <div
              class="max-h-64 space-y-2 overflow-y-auto p-2"
            >
              <p v-if="editModelsListLoading" class="text-xs text-accent-500 dark:text-accent-400">
                {{ t("admin.groups.modelsList.loading") }}
              </p>
              <p
