  ...
  <AppLayout>
    <div class="mx-auto max-w-lg space-y-6 py-8">
      ...
      <div v-else-if="errorMessage" class="card p-8 text-center">
        ...
        <h3 class="text-lg font-semibold text-accent-900 dark:text-white">{{ t('payment.airwallexLoadFailed') }}</h3>
        <p class="mt-2 text-sm text-accent-500 dark:text-accent-400">{{ errorMessage }}</p>
