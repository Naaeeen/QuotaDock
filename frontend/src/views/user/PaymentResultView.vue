        ...
        <div v-if="order" class="rounded-xl bg-white p-5 shadow-sm dark:bg-dark-800">
          <div class="space-y-3 text-sm">
            ...
            <div class="flex justify-between">
              ...
              <span class="font-medium text-accent-900 dark:text-white">{{ formatGatewayAmount(baseAmount) }}</span>
            </div>
            <div v-if="order.fee_rate > 0" class="flex justify-between">
              ...
              <span class="font-medium text-accent-900 dark:text-white">{{ formatGatewayAmount(feeAmount) }}</span>
            </div>
            <div class="flex justify-between">
            ...
            <div v-if="order.amount !== order.pay_amount" class="flex justify-between">
              ...
              <span class="font-medium text-accent-900 dark:text-white">{{ order.order_type === 'balance' ? '$' + order.amount.toFixed(2) : formatGatewayAmount(order.amount) }}</span>
            </div>
            <div class="flex justify-between">
        ...
        <div v-else-if="returnInfo" class="rounded-xl bg-white p-5 shadow-sm dark:bg-dark-800">
          <div class="space-y-3 text-sm">
            ...
            <div v-if="returnInfo.money" class="flex justify-between">
              <span class="text-accent-500 dark:text-accent-400">{{ t('payment.orders.payAmount') }}</span>
              <span class="font-medium text-accent-900 dark:text-white">{{ formatGatewayAmount(Number(returnInfo.money) || 0) }}</span>
            </div>
