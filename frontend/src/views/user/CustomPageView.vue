...
.toc-sidebar {
  @apply flex flex-col h-full border-r border-accent-200 dark:border-dark-600 bg-accent-50 dark:bg-dark-800;
  width: min(240px, 30%);
  min-width: 160px;
  max-width: 280px;
  overflow: hidden;
...
.toc-header {
  @apply flex items-center justify-between px-4 py-3 border-b border-accent-200 dark:border-dark-600;
}

.toc-title {
  @apply text-sm font-semibold text-accent-700 dark:text-dark-200;
}

.toc-close-btn {
  @apply p-1 rounded text-accent-400 hover:text-accent-600 dark:hover:text-dark-200 hover:bg-accent-200 dark:hover:bg-dark-600 transition-colors;
}
...
.toc-item {
  ...
  @apply text-accent-600 dark:text-dark-300 hover:text-accent-900 dark:hover:text-white hover:bg-accent-200 dark:hover:bg-dark-600;
}
...
.toc-toggle-btn {
  ...
  @apply bg-white dark:bg-dark-700 border border-accent-200 dark:border-dark-500;
  @apply text-accent-600 dark:text-dark-300 hover:bg-accent-100 dark:hover:bg-dark-600;
...
.markdown-page-content h1 { @apply text-3xl font-bold mt-8 mb-4 pb-2 border-b border-accent-200 dark:border-dark-600; }
...
.markdown-page-content blockquote { @apply border-l-4 border-accent-300 dark:border-dark-500 pl-4 italic text-accent-600 dark:text-dark-300 my-4; }
...
.markdown-page-content th { @apply border border-accent-300 dark:border-dark-500 px-3 py-2 bg-accent-50 dark:bg-dark-700 font-semibold text-left; }
.markdown-page-content td { @apply border border-accent-300 dark:border-dark-500 px-3 py-2; }
.markdown-page-content code { @apply bg-accent-100 dark:bg-dark-700 px-1.5 py-0.5 rounded text-sm font-mono; }
.markdown-page-content pre { @apply bg-accent-900 dark:bg-dark-900 text-accent-100 p-4 rounded-lg overflow-x-auto my-4 relative; }
.markdown-page-content pre code { @apply bg-transparent p-0 text-inherit; }
.markdown-page-content hr { @apply my-6 border-accent-200 dark:border-dark-600; }
