          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-accent-500 transition-colors hover:bg-primary-50 hover:text-primary-600 dark:hover:bg-primary-900/20 dark:hover:text-primary-400"
              >
        ...
        <div class="border-b border-accent-100 p-2 dark:border-dark-700">
          <div class="relative">
            ...
            <input
              ...
              type="text"
              class="w-full rounded-lg border border-accent-200 bg-accent-50 py-1.5 pl-8 pr-3 text-sm text-accent-900 placeholder-accent-400 outline-none focus:border-primary-300 focus:ring-1 focus:ring-primary-300 dark:border-dark-600 dark:bg-dark-700 dark:text-white dark:placeholder-accent-500 dark:focus:border-primary-600 dark:focus:ring-primary-600"
...
const executeCcsImport = (row: ApiKey, clientType: CcSwitchClientType) => {
  ...
  const providerName = (publicSettings.value?.site_name || 'QuotaDock').trim() || 'QuotaDock'
