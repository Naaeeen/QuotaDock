...
const BADGE: Record<Platform, string> = {
  ...
  gemini: 'bg-primary-500/10 text-primary-600 border-primary-500/30 dark:text-primary-400',
}
const BADGE_DEFAULT = 'bg-accent-500/10 text-accent-600 border-accent-500/30 dark:text-accent-400'
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  gemini: 'bg-primary-500/10 text-primary-600 dark:bg-primary-500/10 dark:text-primary-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  gemini: 'border-primary-500/20 dark:border-primary-500/20',
}
...
const TEXT: Record<Platform, string> = {
  ...
  gemini: 'text-primary-600 dark:text-primary-400',
}
...
const ICON: Record<Platform, string> = {
  ...
  gemini: 'text-primary-500 dark:text-primary-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  gemini: 'bg-primary-500 text-white hover:bg-primary-600 active:bg-primary-700 dark:bg-primary-500/80 dark:hover:bg-primary-500',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  gemini: 'bg-primary-100 text-primary-700 dark:bg-primary-900/40 dark:text-primary-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  gemini: 'from-primary-500 to-primary-700',
}
