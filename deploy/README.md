# QuotaDock Deployment Files

This directory contains files for deploying QuotaDock on Linux servers.
...
QuotaDock supports three methods to connect to Gemini:
...
QuotaDock supports TLS fingerprint simulation to make requests appear as if they come from the official Claude CLI (Node.js client).
