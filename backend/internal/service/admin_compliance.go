...
const (
	...
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 QuotaDock 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the QuotaDock Deployment and Operation Compliance Commitment"
