...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "QuotaDock", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "QuotaDock", "https://example.com/reset", "en-US"))
...
func (s *notificationEmailTestSMTPServer) settings() map[string]string {
	...
	return map[string]string{
		...
		SettingKeySMTPFromName: "QuotaDock",
